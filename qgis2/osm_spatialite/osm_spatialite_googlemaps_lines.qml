    ...
    <rules key="{0d36de44-6814-4fea-a48c-d678277f9bd4}">
      <rule filter="&quot;highway&quot; is not null" key="{f1926d8e-6ccf-40d0-a1b2-aadaeb0e4ac4}" label="roads">
        <rule filter="&quot;highway&quot; = 'motorway' " key="{8ef7a743-8700-4afe-9018-fc3dbcb8fe50}" label="motorway">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" key="{c6cbaf95-2947-4da4-b098-d1c33b31654a}" symbol="0" label="motorway"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" key="{e0fcf762-24dc-4be8-9a70-0ce423f800dd}" symbol="1" label="tunnel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'motorway_link','trunk','primary')" key="{460cf940-02d3-46c1-8af3-d81902e55292}" label="trunk &amp; primary">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" key="{be0a9363-979f-44b5-9833-9039fc2c8554}" symbol="2" label="trunk &amp; primary"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" key="{144c24ee-f792-4030-bc85-01d5dd5099f1}" symbol="3" label="tunnel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'trunk_link','primary_link','secondary','secondary_link','road','tertiary','tertiary_link')" key="{79dfc622-0af0-480a-b30e-bab186370428}" symbol="4" label="roads"/>
        <rule scalemaxdenom="1000" filter="&quot;highway&quot; is not null" key="{66a14f73-bc31-4103-8560-0db9e17d7fb7}" symbol="5" scalemindenom="1" label="minor roads"/>
        <rule scalemaxdenom="125000" filter="&quot;highway&quot; is not null" key="{73f736c6-ce27-41de-8d1a-e156a03ead91}" symbol="6" scalemindenom="1000" label="minor roads"/>
      </rule>
      <rule filter="&quot;other_tags&quot; LIKE '%&quot;rail&quot;%' or &quot;other_tags&quot; LIKE '%&quot;railway&quot;%'" key="{fda0c98a-1143-4220-899c-eafc75601a6f}" symbol="7" label="rails"/>
      <rule filter="&quot;waterway&quot; = 'river'" key="{f3082c5b-c4d0-4e58-8dba-ee4c9d2d6ef5}" label="river">
        <rule scalemaxdenom="125000" key="{2ea395c2-750f-4578-8764-4725bf71c7dc}" symbol="8" label="river"/>
        <rule key="{fde5ded2-bf93-48f2-aa0c-5c717be6ae08}" symbol="9" scalemindenom="125000" label="river"/>
      </rule>
    </rules>
    <symbols>
