...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      ...
      <rule filter=" &quot;aeroway&quot; is not null or &quot;landuse&quot; = 'industrial'" symbol="2"/>
      <rule filter="&quot;landuse&quot; = 'residential'" symbol="3"/>
    </rules>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="0" type="0" name="admin_level"/>
    <edittype labelontop="0" editable="0" type="0" name="aeroway"/>
    <edittype labelontop="0" editable="0" type="0" name="amenity"/>
    <edittype labelontop="0" editable="0" type="0" name="barrier"/>
    <edittype labelontop="0" editable="0" type="0" name="boundary"/>
    <edittype labelontop="0" editable="0" type="0" name="building"/>
    <edittype labelontop="0" editable="0" type="0" name="craft"/>
    <edittype labelontop="0" editable="0" type="0" name="geological"/>
    <edittype labelontop="0" editable="0" type="0" name="historic"/>
    <edittype labelontop="0" editable="0" type="0" name="land_area"/>
    <edittype labelontop="0" editable="0" type="0" name="landuse"/>
    <edittype labelontop="0" editable="0" type="0" name="leisure"/>
    <edittype labelontop="0" editable="0" type="0" name="man_made"/>
    <edittype labelontop="0" editable="0" type="0" name="military"/>
    <edittype labelontop="0" editable="0" type="0" name="name"/>
    <edittype labelontop="0" editable="0" type="0" name="natural"/>
    <edittype labelontop="0" editable="0" type="0" name="office"/>
    <edittype labelontop="0" editable="0" type="0" name="osm_id"/>
    <edittype labelontop="0" editable="0" type="0" name="osm_way_id"/>
    <edittype labelontop="0" editable="0" type="0" name="other_tags"/>
    <edittype labelontop="0" editable="0" type="0" name="place"/>
    <edittype labelontop="0" editable="0" type="0" name="shop"/>
    <edittype labelontop="0" editable="0" type="0" name="sport"/>
    <edittype labelontop="0" editable="0" type="0" name="tourism"/>
    <edittype labelontop="0" editable="0" type="0" name="type"/>
  </edittypes>
  <editform>.</editform>
