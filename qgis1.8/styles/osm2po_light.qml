...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="1" type="RuleRenderer">
    <rules>
      <rule filter="clazz = 11" symbol="0" label="highway"/>
      <rule scalemaxdenom="100000" filter="clazz >= 12 and clazz &lt;= 16" symbol="1" scalemindenom="1" label="primary"/>
      <rule scalemaxdenom="500000" filter="clazz >= 12 and clazz &lt;= 16" symbol="2" scalemindenom="100000" label="primary"/>
      <rule scalemaxdenom="100000" filter="clazz >= 21 and clazz &lt;= 22" symbol="3" scalemindenom="1" label="secondary"/>
      <rule scalemaxdenom="500000" filter="clazz >= 21 and clazz &lt;= 22" symbol="4" scalemindenom="100000" label="secondary"/>
      <rule scalemaxdenom="100000" filter="clazz = 31" symbol="5" scalemindenom="1" label="tertiary"/>
      <rule scalemaxdenom="10000" symbol="6" scalemindenom="1"/>
      <rule scalemaxdenom="50000" symbol="7" scalemindenom="10000"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN (length(osm_name)>6)*(clazz = 11 or clazz = 13 or clazz = 15 or clazz = 21) THEN osm_name END"/>
